...
export default function Login() {
    ...
    async function verificaLogin(data: Inputs) {
        ...
        if (response.status == 200) {
            ...
            // "coloca" os dados do paciente no contexto
            logaPaciente(dados)
            
            // se o paciente indicou que quer se manter conectado
            // salvamos os dados (id) dele em localStorage
            if (data.manter) {
                localStorage.setItem("pacienteKey", dados.id)
            } else {
            ...
            // carrega a página principal, após login do paciente
            navigate("/")
        } else {
