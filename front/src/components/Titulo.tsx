  ...
  <div className="flex justify-between items-center p-4 h-20">
    ...
    <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
        ...
        {paciente.id ? (
            ...
            <span className="cursor-pointe text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-4 py-2 text-center" onClick={pacienteSair}>Sair</span>
            </>
        ) : (
